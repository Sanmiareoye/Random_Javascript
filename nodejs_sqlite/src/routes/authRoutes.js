...
// Resigster a new user enpoint /auth/reigter
router.post("/register", (req, res) => {
  const { username, password } = req.body;
  // save the username and an irreversibly encrypted password
  // save sanms@gmail.com | jnfnrfnrjnkjernjn
...
router.post("/login", (req, res) => {
  // we get their email, and we look up the passwod in the email in the db
  // but we get it back and see its encryoted, which means that we cannot
